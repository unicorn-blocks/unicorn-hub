...
export default function PreorderPage({ initialRemaining }) {
  ...
  const translations = {
    en: {
      ...
      header: {
        ...
        priceVIP: 'Pre-order Now, Pay Later',
        priceRetail: '', // Unused
        deposit: 'Secure the $149 VIP price (retail $199) with a $5 fully refundable pre-order',
        scarcityPrefix: 'Only',
                ...
                <div className="pricing-row-sub">
                  <div className="pricing-deposit-text">
                    {language === 'zh' ? (
                      ...
                      <>Secure the <span className="highlight-price">$149</span> VIP price (<span className="retail-price">retail $199</span>) with a <span className="highlight-price">$5</span> fully refundable pre-order.</>
                    )}
                  </div>
